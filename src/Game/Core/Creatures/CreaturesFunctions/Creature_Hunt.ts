...
import { spriteBoxSetDirectionAccordingOtherSpriteBoxBy10Degrees, spriteBoxSetDirectionAccordingOtherSpriteBoxRad } from '../../Utilities/spriteBox/directionSpriteBox';
