...
import water_4frames from "../../Assets/mapBlocks/Sprite-water-4frames.png"
...
const waterTexture = PIXI.Texture.from(water_4frames);
...
export const selectTexture = (sprite: MapBlocksSprite): PIXI.Texture => {
    switch (sprite) {
        ...
        case MapBlocksSprite.ground_water: return waterTexture
